...
/// <see cref="BuildingKind.AirFactory"/> or <see cref="BuildingKind.Port"/>
...
public static class CaptureRules
{
    ...
    {
        BuildingKind.City or BuildingKind.AirFactory or BuildingKind.Port => true,
        _ => false,
    };
    ...
    public static IReadOnlyDictionary<global::Wolfgang.Conflict.Classic.Engine.Hex.HexCoord, Side> ComputeFlips(GameState state, Side side)
    {
        if (state is null)
        {
        ...
        var flips = new Dictionary<global::Wolfgang.Conflict.Classic.Engine.Hex.HexCoord, Side>();
