...
param(
    [Parameter()]
    [string]$Repository = "@Chris-Wolfgang/Conflict.Classic",
...
if ($Repository -eq "@Chris-Wolfgang/Conflict.Classic" -or -not $Repository) {
    ...
    try {
        ...
        if ($Repository -eq "@Chris-Wolfgang/Conflict.Classic") {
